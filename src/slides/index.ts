...

  {
    ...
    slides: [
      ...
      },
      {
        ...
        summary: "Verse, Pre-Chorus, Chorus, Bridge, Hook",
        content: {
          type: "learn",
      ...
      },
      {
        ...
        content: {
          ...
          examples: [
            "Where is the **verse**?",
            "Can you hear a **pre-chorus** — a short build-up before the chorus?",
            "Where is the **chorus**? What part repeats?",
            "What line feels like the **hook**?",
            "Is there a **bridge** or a key change near the end?",
          ],
        },
      },
      {
        ...
        summary: "Verse, Pre-Chorus, Chorus, Hook, Bridge",
        content: {
          type: "practice",
          body: "Look at the lyrics sheet.\n\nLabel each section with the part it belongs to:",
          examples: [
            "**Verse** — the story-telling part",
            "**Pre-Chorus** — the short lift-up before the chorus",
            "**Chorus** — the main repeated message",
            "**Hook** — the catchiest line",
            "**Bridge** — the different/changed part, if you notice one",
          ],
          tip: "Then compare your labels with a partner. Partner talk: How did you know which part was the pre-chorus, and which was the chorus?",
        },
      },
      {
        id: 13,
...
export const writingSheets: WritingSheet[] = [
  ...
  },
  {
    ...
    description: "Write one verse and one chorus using language features and song structure.",
    color: "#10b981",
    walt: "We Are Learning To write song lyrics using language features and structure.",
    instructions: [
      "Choose ONE topic from these five: friendship, dreams, courage, belonging, or home / whānau.",
      "Plan your song. What feeling do you want to create? What is your main message?",
      "Write your HOOK — the one short line you want everyone to remember. This will go in your chorus.",
      "Write one VERSE (4 lines). The verse tells the story or sets the scene.",
      "Write one CHORUS (4 lines). The chorus shares your main message and should include your hook.",
      "Use at least TWO of these language features: repetition, rhyme, or imagery.",
      "Read your lyrics aloud. Does it sound like a song? Can you hear the features clearly?",
    ],
    sentenceStarters: [
      "I remember when ...",
      "Every day I ...",
    ...
    wordBank: [
      ...
      "bright", "golden", "shining", "whisper",
      "ocean", "mountain", "sky", "sea",
      "home", "heart", "hope", "dream",
      "rise", "fly", "stand", "stay",
      "side by side", "hand in hand",
    ],
    examples: [
      {
        label: "Example 1 — Topic: Friendship",
        text: "VERSE\nWe met on the first day of school,\nlaughed at the same silly jokes,\nshared snacks at the bottom of the field,\ntold secrets nobody else knows.\n\nCHORUS\nYou and me, side by side,\nthrough the laughter and the long, long days.\nYou and me, side by side —\nnothing's gonna change the way we stay.",
        note: "Features used: repetition (\"You and me, side by side\"), rhyme (\"days\" / \"stay\"), imagery (\"bottom of the field\"). Hook: \"You and me, side by side\".",
      },
      {
        label: "Example 2 — Topic: Home / Whānau",
        text: "VERSE\nWooden floor and Mum's old chair,\nthe kettle whistles in the morning air,\nout the window, hills of green,\nthis is where I've always been.\n\nCHORUS\nHome, home, you wait for me,\nthis is where I'm meant to be.\nHome, home, you wait for me,\nmy whānau and my memory.",
        note: "Features used: repetition (\"Home, home, you wait for me\"), rhyme (\"chair\" / \"air\", \"green\" / \"been\", \"me\" / \"be\"), imagery (\"kettle whistles\", \"hills of green\"). Hook: \"Home, home, you wait for me\".",
      },
    ],
  },
];
